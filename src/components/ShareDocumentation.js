    ...
    return (
        <div className="documentation-container">
            <div className="documentation-card">
                ...
                {message && (
                    <div className={`documentation-message ${message.includes('Erreur') || message.includes('non autorisé') ? 'error' : 'success'}`}>
                        {message}
                    </div>
                )}
                ...
                {isFetchingClasses ? (
                    ...
                    !isFetchingClasses && (
                        <div className="documentation-warning">
                            ...
                            <p>{message || "Vous n'avez pas encore créé de classes. Veuillez créer une classe avant de pouvoir partager des documents."}</p>
                        </div>
                    )
                )}
            </div>
